#!/usr/bin/env python
"""Gate: does a traffic light govern the ego lane at all?\n\nDerived from train_vqa_v2.py.
...
QUESTION = ("Is there a traffic light that controls the lane the ego vehicle is in? "
...
def build_sample(model, row, cond='full'):
    ...
    _ans = "no" if row["label"] == "none" else "yes"
